...
wn.title("Covid Arena! by wayster de melo")
wn.bgcolor("black")
...
class Game():
    ...
    def render_info(self, pen, score, active_enemies = 0):
        ...
        character_pen.draw_string(pen, "COVID ARENA", 400, 270)
        character_pen.draw_string(pen, "PONTOS {}".format(score), 400, 240)
        character_pen.draw_string(pen, "INIMIGOS {}".format(active_enemies), 400, 210)
        character_pen.draw_string(pen, "VIDAS {}".format(player.lives), 400, 180)
        character_pen.draw_string(pen, "NIVEL {}".format(game.level), 400, 150)
...
character_pen.draw_string(pen, "COVID ARENA", 0, 160)

character_pen.scale = 1.0
character_pen.draw_string(pen, "BY WAYSTER DE MELO", 0, 100)
...
pen.goto(0, 20)
pen.stamp()
character_pen.draw_string(pen, "INIMIGO", 0, -20)

pen.shape("circle")
pen.color("blue")
pen.goto(150, 20)
pen.stamp()
character_pen.draw_string(pen, "INIMIGO 2", 150, -20)
character_pen.scale = 1.0
character_pen.draw_string(pen, "PRESSIONE S PARA COMEÇAR", 0, -240)
